 ...
 */
public class GUIIPS extends javax.swing.JFrame {
    ...
    public GUIIPS() {
        ...
        citas = new HashMap<>();
        citas = Collections.synchronizedMap(citas);
        try {
    ...
    private void initComponents() {
        ...
        tablaPaises.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Documento", "Puntaje de Gravedad", "Fecha"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIIPS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void llenarCitas(ArrayList<Cita> citas)
    {
        try{
            for (Cita c : citas) 
            {
                this.citas.put(c.paciente.documento, c);
            }
    ...
    {
        try{
            citas.replace(c.paciente.documento,c);
    ...
    {
        try{
            citas.remove(c.paciente.documento);
            mostrar(); 
        }
        catch(Exception e)
        {
    ...
    {
        try{
            citas.put(c.paciente.documento, c);
    ...
    public void mostrar()
    {
        try
        {
            Object matriz[][] = new Object[citas.size()][4];

            ArrayList<Cita> aux = new ArrayList<>(citas.values());
