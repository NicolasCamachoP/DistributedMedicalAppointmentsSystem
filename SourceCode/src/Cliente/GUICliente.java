...
public class GUICliente extends javax.swing.JFrame {
    ...
    public GUICliente() {
        ...
        pacientes = Collections.synchronizedMap(pacientes);
        try {
        ...
        Cliente_Servidor cs = new Cliente_Servidor(this);
    }
    ...
    public void llenarPacientes(ArrayList<Paciente> pacientes)
    {
        try{
            for (Paciente p : pacientes) 
            {
                this.pacientes.put(p.documento, p);
            }
    ...
    public void mostrar()
    {
        try
        {
            Object matriz[][] = new Object[pacientes.size()][4];

            ArrayList<Paciente> aux = new ArrayList<>(pacientes.values());
        
            int i = 0;
            for (Paciente p : aux)
            {
                matriz[i][0] = p.nombre;
                matriz[i][1] = p.documento;
                matriz[i][2] = p.edad;
                matriz[i][3] = p.eps;
                i++;
            }
