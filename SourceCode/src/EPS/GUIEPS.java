...
public class GUIEPS extends javax.swing.JFrame {
    ...
    public GUIEPS() {
        ...
        EPS_Servidor es = new EPS_Servidor(this);
        try {
            this.labelBroker.setText("EPS: "+es.eps.getName());
        } catch (RemoteException ex) {
            Logger.getLogger(GUIEPS.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIEPS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void llenarPacientes(ArrayList<Cita> citas)
    {
        try{
            for (Cita c : citas) 
            {
