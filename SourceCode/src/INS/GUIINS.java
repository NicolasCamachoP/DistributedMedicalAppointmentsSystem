 ...
 */
public class GUIINS extends javax.swing.JFrame {
    ...
    public GUIINS() {
        ...
        casos = new HashMap<>();
        casos = Collections.synchronizedMap(casos);
        try {
        ...
        INS_Servidor es = new INS_Servidor(this);
    }
    ...
    private void initComponents() {
        ...
        tablaPaises.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Documento", "Puntaje Calculado", "Gravedad"
            }
        ) {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(scrollEstado, javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(scrollTabla, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 838, Short.MAX_VALUE)))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(IP))
                .addGap(20, 20, 20)
                .addComponent(labelPaises, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIINS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public Map<String,Caso> casos;
    
    public void llenarCasos(ArrayList<Caso> casos)
    {
        try{
            for (Caso c : casos) 
            {
                this.casos.put(c.paciente.documento, c);
            }
    ...
    public void actualizarCaso(Caso c)
    {
        try{
            casos.replace(c.paciente.documento,c);
    ...
    {
        try{
            casos.remove(c.paciente.documento);
            mostrar(); 
        }
        catch(Exception e)
        {
    ...
    {
        try{
            casos.put(c.paciente.documento, c);
    ...
    public void mostrar()
    {
        try
        {
            Object matriz[][] = new Object[casos.size()][4];

            ArrayList<Caso> aux = new ArrayList<>(casos.values());
        
            int i = 0;
            for (Caso c : aux)
            {
                matriz[i][0] = c.paciente.nombre;
                matriz[i][1] = c.paciente.documento;
                matriz[i][2] = c.puntuacion;
                matriz[i][3] = c.gravedad;
                i++;
            }
